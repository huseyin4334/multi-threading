...
@AllArgsConstructor
@Slf4j
public class TryLockTaskOne implements Runnable {
...
/*
        Eğer bu tarz birşey denersem yine deadlock olacağım. O sebeple yukarıdaki yöntem kilitlenmeyi önleyecektir.
